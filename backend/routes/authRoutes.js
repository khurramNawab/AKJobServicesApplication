...
import {
    ...
    getMe, sendOTP, verifyOTP, verifyEmail, resendVerification,
    logoutUser, logoutAllDevices, getActiveSessions, revokeSession
...
const resetLimiter = rateLimit({
    windowMs: 10 * 60 * 1000,
    max: 5,
    message: { success: false, message: 'Too many password reset requests. Try again in 10 minutes.' },
    standardHeaders: true,
    legacyHeaders: false,
});
