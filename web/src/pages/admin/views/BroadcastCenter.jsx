    ...
    <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 text-left">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 px-4">
        <div className="space-y-1">
          <h2 className="text-3xl font-black text-white tracking-tighter uppercase leading-none">Broadcast <span className="text-blue-500">Center</span>.</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <motion.div 
          ...
          className="p-10 rounded-[3rem] bg-[#1E293B] border border-white/5 space-y-10 shadow-2xl relative overflow-hidden group"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
             <div className="space-y-4">
                ...
                <input 
                   ...
                   className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-[11px] font-black text-white tracking-widest focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all uppercase"
                />
             </div>
             <div className="space-y-4">
                ...
                <textarea 
                   ...
                   rows={5}
                   className="w-full bg-white/5 border border-white/10 rounded-[2.5rem] px-8 py-6 text-[11px] font-black text-white tracking-widest focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all uppercase resize-none shadow-inner"
                />
             </div>
             ...
             <button 
               type="submit"
               disabled={loading}
               className="w-full py-5 rounded-3xl bg-blue-600 text-white font-black text-[11px] uppercase tracking-[0.3em] shadow-xl shadow-blue-600/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4 disabled:opacity-50"
             >
        ...
        <motion.div 
          ...
          className="space-y-8"
        >
           <div className="p-8 rounded-[2.5rem] bg-[#1E293B] border border-white/5 space-y-6 flex flex-col items-start">
              <div className="flex items-center gap-4 text-left">
                 <div className="p-3 rounded-2xl bg-amber-500/10 text-amber-500 border border-amber-500/20">
                    <Zap size={20} />
                 </div>
                 <div>
                    <h4 className="text-sm font-black text-white uppercase tracking-tight">Transmission Protocol</h4>
           ...
           <div className="p-8 rounded-[2.5rem] bg-[#1E293B] border border-white/5 space-y-6 flex flex-col items-start">
              <div className="flex items-center gap-4 text-left w-full">
                 ...
                 <div className="flex-1">
                    <h4 className="text-sm font-black text-white uppercase tracking-tight">Recent Signals</h4>
