    ...
    <div className="max-w-4xl mx-auto px-6 pt-28 pb-20 w-full relative">
      ...
      >
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-black text-white tracking-tight">Privacy <span className="text-indigo-400">Policy</span></h1>
        ...
        <div className="prose prose-invert max-w-none text-slate-300 leading-relaxed space-y-8">
          ...
          <section className="p-6 bg-indigo-500/10 rounded-2xl border border-indigo-500/20">
