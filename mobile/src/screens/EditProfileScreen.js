...
const EditProfileScreen = ({ navigation }) => {
  ...
  const handlePhotoUpload = async () => {
    try {
      ...
      const res = await api.put("/candidates/me/photo", formData, {
        headers: {
      ...
      if (res.data.success) {
        ...
        throw new Error(res.data.message || "Error uploading photo");
      }
    } catch (error) {
  ...
  const handleResumeUpload = async () => {
    try {
      ...
      if (file.size > 300 * 1024) {
        Alert.alert(
          "File too large",
          "Please upload a file smaller than 300KB",
        );
        return;
      }
            ...
            <View style={styles.row}>
              <View style={[styles.inputGroup, { flex: 1, marginRight: 8 }]}>
                ...
                <TextInput
                  ...
                  value={form.phone}
                  onChangeText={(text) =>
                    setForm({ ...form, phone: text.replace(/[()\-\s]/g, "") })
                  }
                />
              </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setForm({ ...form, preferredJobTitle: text })
                }
              />
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setForm({ ...form, preferredLocation: text })
                }
              />
            </View>
          </View>
              ...
              >
                <View
                  style={[
                    ...
                    {
                      backgroundColor: form.resumeUrl
                        ? COLORS.primary + "10"
                ...
                >
                  <Ionicons
                    name={
                      form.resumeUrl ? "document-text" : "cloud-upload-outline"
                    }
                    size={24}
                    color={
                      form.resumeUrl ? COLORS.primary : COLORS.textTertiary
                    }
                  />
                </View>
                <View style={{ flex: 1 }}>
                  <Text
                    style={[styles.resumeTitle, { color: COLORS.textPrimary }]}
                  >
                  ...
                  >
                    {form.resumeUrl ? "Tap to change file" : "Max size 300KB"}
                  </Text>
                </View>
                {form.resumeUrl && (
                  <Ionicons
